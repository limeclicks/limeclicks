...
def test_fastgenerations_scraping():
    ...
    if not os.getenv('SCRAPE_DO_API_KEY'):
        print("❌ Error: SCRAPE_DO_API_KEY not found in environment")
        print("   Please set your Scrape.do API key to continue")
        return
    ...
    # Option 1: Manual scraping (for testing)
    print("\n" + "-" * 40)
    print("Option 1: Direct Scrape.do API Test")
    print("-" * 40)
    ...
    # Option 2: Use the task system
    print("\n" + "-" * 40)
    print("Option 2: Via Task System (Production Method)")
    print("-" * 40)
